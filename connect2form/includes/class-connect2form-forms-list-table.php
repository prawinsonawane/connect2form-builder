...
class Connect2Form_Forms_List_Table extends WP_List_Table {
    ...
    public function get_columns() {
        return array(
            ...
            'id' => __('ID', 'connect2form'),
            'form_title' => __('Form Title', 'connect2form'),
            'shortcode' => __('Shortcode', 'connect2form'),
            'status' => __('Status', 'connect2form'),
            'created_at' => __('Created', 'connect2form'),
            'updated_at' => __('Last Modified', 'connect2form')
        );
    }
    ...
    public function column_status($item) {
        ...
        $label = $status === 'active' ? __('Active', 'connect2form') : __('Inactive', 'connect2form');
        return sprintf(
