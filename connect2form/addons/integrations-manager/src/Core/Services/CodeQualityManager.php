...
class CodeQualityManager {
     ...
     *
     * @since    2.0.0
     * @param    string $method_name Method name to validate.
     * @return   bool
     */
     ...
     *
     * @since    2.0.0
     * @param    string $variable_name Variable name to validate.
     * @return   bool
     */
    ...
    public static function validateIntegrationClass(string $class_name): array {
        ...
        if (!$reflection->implementsInterface('Connect2Form\Integrations\Core\Interfaces\IntegrationInterface')) {
    ...
    public static function generateClassDocumentation(string $class_name): string {
        ...
        $doc .= " *\n";
        $doc .= " * @package Connect2Form\\Integrations\n";
        $doc .= " * @since " . CONNECT2FORM_INTEGRATIONS_VERSION . "\n";
        $doc .= " */\n";
