...
<div class="wrap">
    ...
    <p class="description">
        <?php esc_html_e('Configure your integrations by clicking on each integration below. Global settings apply to all forms unless overridden at the form level.', 'connect2form'); ?>
    </p>

    <?php if (empty($integrations)): ?>
        <div class="notice notice-warning">
            <p><?php esc_html_e('No integrations are available. Please check your plugin installation.', 'connect2form'); ?></p>
        </div>
    <?php else: ?>
        <div class="connect2form-integrations-grid">
            <?php foreach ($integrations as $integration): ?>
                <div class="integration-card <?php echo esc_attr($integration->isConfigured() ? 'configured' : 'unconfigured'); ?>">
...
<style>
.connect2form-integrations-grid {
    display: grid;
