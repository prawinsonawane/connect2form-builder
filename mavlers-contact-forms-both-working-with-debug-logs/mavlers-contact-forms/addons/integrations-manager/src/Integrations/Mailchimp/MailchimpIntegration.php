...
class MailchimpIntegration extends AbstractIntegration {
    ...
    protected function init() {
        error_log("MailchimpIntegration: init() method called");
        ...
        error_log("MailchimpIntegration: init() method completed");
    }
    ...
    public function init_components() {
        error_log("MailchimpIntegration: Initializing components");
    ...
    public function register_ajax_handlers() {
        ...
        error_log("MailchimpIntegration: register_ajax_handlers() completed - all handlers registered");
    }
