...
jQuery(document).ready(function($) {
    // Debug: Check integration checkboxes
    console.log('=== INTEGRATION SECTION DEBUG ===');
    $('.integration-enable-checkbox').each(function() {
        var integration = $(this).data('integration');
        var isChecked = $(this).is(':checked');
        console.log('Integration:', integration, 'Checked:', isChecked);
    });
    console.log('=== END INTEGRATION SECTION DEBUG ===');
    ...
    $('.integration-enable-checkbox').on('change', function() {
        ...
        console.log('Integration checkbox changed:', integration, 'Enabled:', isEnabled);
        ...
        if (isEnabled) {
            ...
            if (integration === 'mailchimp' && window.mailchimpFormSettings) {
                console.log('Loading saved Mailchimp settings:', window.mailchimpFormSettings);
