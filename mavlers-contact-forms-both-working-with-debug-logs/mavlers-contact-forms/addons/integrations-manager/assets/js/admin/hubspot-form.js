...
(function($) {
    ...
    function initializeHubSpotSettings() {
        console.log('=== Initializing HubSpot Settings ===');
        ...
        isInitialized = true;
        console.log('=== HubSpot Settings Initialized ===');
    }
    ...
    function initializeEventHandlers() {
        ...
        $(document).on('change', '.hubspot-property-select', function() {
            ...
            console.log('Data field-id:', $(this).data('field-id'));
    ...
    function handleCustomObjectChange() {
        ...
        console.log('Custom object changed to:', customObject);
    ...
    function loadObjectProperties(objectType) {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('HubSpot properties response:', response);
                if (response.success && response.data) {
                    hubspotProperties = response.data;
                    console.log('HubSpot properties loaded:', hubspotProperties);
                    updateFieldMappingTable();
                } else {
    ...
    function loadCustomObjectProperties(objectName) {
        console.log('Loading custom object properties for:', objectName);
        console.log('Object name type:', typeof objectName);
        console.log('Object name length:', objectName ? objectName.length : 0);
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('Custom object properties response:', response);
                if (response.success && response.data) {
                    hubspotProperties = response.data;
                    console.log('HubSpot custom object properties loaded:', hubspotProperties);
                    updateFieldMappingTable();
                } else {
    ...
    function loadHubSpotProperties() {
        ...
        console.log('HubSpot properties will be loaded when object type is selected');
    }
    ...
    function loadSavedSettings() {
        if (window.hubspotFormSettings) {
            console.log('Loading saved settings:', window.hubspotFormSettings);
            ...
            // Load field mapping
            console.log('Loading saved field mapping:', window.hubspotFormSettings.field_mapping);
            ...
            console.log('Loaded currentMapping:', currentMapping);
    ...
    function updateFieldMappingTable() {
        ...
        let tableHtml = '';
        console.log('Creating field mapping table with:', { formFields, hubspotProperties, currentMapping });
        formFields.forEach(function(field) {
            ...
            console.log('Creating dropdown for field:', field.id, 'with properties:', hubspotProperties.length);
            ...
            console.log('Generated dropdown HTML for field', field.id, ':', dropdownHtml);
        ...
        console.log('Field mapping table updated. Checking dropdowns:');
        $('.hubspot-property-select').each(function(index) {
    ...
    function handleFieldMappingChange() {
        ...
        console.log('Field mapping change:', { fieldId, propertyName, currentMapping });
        ...
        console.log('Updated currentMapping:', currentMapping);
    ...
    function handleFormSettingsSave() {
        ...
        console.log('Saving HubSpot form settings:', formData);
        console.log('Current mapping being sent:', currentMapping);
        ...
        $.ajax({
            ...
            data: formData,
            success: function(response) {
                console.log('Form settings save response:', response);
            ...
            error: function(xhr, status, error) {
                console.error('Form settings save error:', error);
