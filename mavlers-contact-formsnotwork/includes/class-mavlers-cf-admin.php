...
class Mavlers_CF_Admin {
    ...
    public function __construct($plugin_name, $version) {
        ...
        add_action('wp_ajax_mavlers_cf_debug_form_settings', array($this, 'ajax_debug_form_settings'));
    }
                ...
                <div class="form-builder-tab-contents">
                        ...
                        <div class="form-builder-fields-layout">
                            ...
                            <div class="form-fields-sidebar">
                                ...
                                <div class="field-settings-panel">
                                    <h3><?php _e('Field Settings', 'mavlers-contact-forms'); ?></h3>
                                    <div class="no-field-selected">
                                        <?php _e('Select a field to edit its settings', 'mavlers-contact-forms'); ?>
                                    </div>
                                    <div id="field-settings" style="display: none;">
                                        <div class="field-setting">
                                            <label for="field-type"><?php _e('Field Type', 'mavlers-contact-forms'); ?></label>
                                            <select id="field-type" disabled>
                                                <?php foreach ($field_types as $type => $field) : ?>
                                                    <option value="<?php echo esc_attr($type); ?>"><?php echo esc_html($field['label']); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-label"><?php _e('Label', 'mavlers-contact-forms'); ?></label>
                                            <input type="text" id="field-label" class="widefat">
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-description"><?php _e('Description', 'mavlers-contact-forms'); ?></label>
                                            <textarea id="field-description" class="widefat" rows="3"></textarea>
                                        </div>

                                        <div class="field-setting">
                                            <label>
                                                <input type="checkbox" id="field-required">
                                                <?php _e('Required', 'mavlers-contact-forms'); ?>
                                            </label>
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-placeholder"><?php _e('Placeholder', 'mavlers-contact-forms'); ?></label>
                                            <input type="text" id="field-placeholder" class="widefat">
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-default-value"><?php _e('Default Value', 'mavlers-contact-forms'); ?></label>
                                            <input type="text" id="field-default-value" class="widefat">
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-css-class"><?php _e('CSS Class', 'mavlers-contact-forms'); ?></label>
                                            <input type="text" id="field-css-class" class="widefat">
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-size"><?php _e('Size', 'mavlers-contact-forms'); ?></label>
                                            <select id="field-size">
                                                <option value="small"><?php _e('Small', 'mavlers-contact-forms'); ?></option>
                                                <option value="medium" selected><?php _e('Medium', 'mavlers-contact-forms'); ?></option>
                                                <option value="large"><?php _e('Large', 'mavlers-contact-forms'); ?></option>
                                            </select>
                                        </div>

                                        <div class="field-setting">
                                            <label for="field-maxlength"><?php _e('Max Length', 'mavlers-contact-forms'); ?></label>
                                            <input type="number" id="field-maxlength" class="widefat" min="0">
                                        </div>

                                        <!-- Type-specific settings -->
                                        <div class="type-specific select-settings radio-settings checkbox-settings multiselect-settings" style="display: none;">
                                            <div class="field-setting">
                                                <label><?php _e('Options', 'mavlers-contact-forms'); ?></label>
                                                <div id="field-options"></div>
                                                <button type="button" id="add-option" class="button"><?php _e('Add Option', 'mavlers-contact-forms'); ?></button>
                                            </div>
                                        </div>

                                        <!-- <div class="type-specific submit-settings" style="display: none;">
                                            <div class="field-setting">
                                                <label for="field-button-type"><?php /* _e('Button Type', 'mavlers-contact-forms'); */ ?></label>
                                                <select id="field-button-type">
                                                    <option value="submit"><?php /* _e('Submit', 'mavlers-contact-forms'); */ ?></option>
                                                    <option value="button"><?php /* _e('Button', 'mavlers-contact-forms'); */ ?></option>
                                                </select>
                                            </div>
                                        </div> -->

                                        <div class="type-specific captcha-settings" style="display: none;">
                                            <div class="field-setting">
                                                <label for="field-captcha-type"><?php _e('reCAPTCHA Type', 'mavlers-contact-forms'); ?></label>
                                                <select id="field-captcha-type">
                                                    <option value="v2_checkbox"><?php _e('v2 Checkbox', 'mavlers-contact-forms'); ?></option>
                                                    <option value="v2_invisible"><?php _e('v2 Invisible', 'mavlers-contact-forms'); ?></option>
                                                    <option value="v3"><?php _e('v3', 'mavlers-contact-forms'); ?></option>
                                                </select>
                                            </div>
                                            <div class="field-setting">
                                                <label for="field-captcha-theme"><?php _e('Theme', 'mavlers-contact-forms'); ?></label>
                                                <select id="field-captcha-theme">
                                                    <option value="light"><?php _e('Light', 'mavlers-contact-forms'); ?></option>
                                                    <option value="dark"><?php _e('Dark', 'mavlers-contact-forms'); ?></option>
                                                </select>
                                            </div>
                                            <div class="field-setting">
                                                <label for="field-captcha-size"><?php _e('Size', 'mavlers-contact-forms'); ?></label>
                                                <select id="field-captcha-size">
                                                    <option value="normal"><?php _e('Normal', 'mavlers-contact-forms'); ?></option>
                                                    <option value="compact"><?php _e('Compact', 'mavlers-contact-forms'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="form-builder-tab-content integration-tab">
                        ...
                        <div class="integration-settings">
                            <!-- New Addon-based Integration System -->
                            <?php if (defined('MAVLERS_CF_INTEGRATIONS_DIR') && file_exists(MAVLERS_CF_INTEGRATIONS_DIR . 'templates/integration-section.php')): ?>
                                <?php
                                // Get available integrations for this form
                                $available_integrations = array();
                                $form_integrations = array();
                                
                                // Get Mailchimp integration specifically for now
                                if (class_exists('Mavlers_CF_Mailchimp_Integration')) {
                                    $mailchimp = new Mavlers_CF_Mailchimp_Integration();
                                    $available_integrations['mailchimp'] = $mailchimp;
                                }
                                
                                // Set form ID for the integration templates
                                $GLOBALS['mavlers_cf_current_form_id'] = $form_id;
                                
                                // Include the integration section template
                                include MAVLERS_CF_INTEGRATIONS_DIR . 'templates/integration-section.php';
                                ?>
                            <?php else: ?>
                                <!-- Fallback if integrations addon not available -->
                                <div class="integration-setting">
                                    <h4>Third-party Integrations</h4>
                                    <p class="description">Install the Integrations Manager addon to connect with Mailchimp, Zapier, and other services.</p>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="integration-setting">
                                ...
                                <div class="form-options">
                                    <label>
                                        <input type="checkbox" id="enable-ajax" <?php checked($form && isset($form->settings) ? $form->settings['enable_ajax'] ?? true : true); ?>>
                                        Enable AJAX submission
                                    </label>
                                    <p class="description">Submit form without page reload.</p>
                                    
                                    <label>
                                        <input type="checkbox" id="enable-scroll-to-error" <?php checked($form && isset($form->settings) ? $form->settings['scroll_to_error'] ?? true : true); ?>>
                                        Scroll to error on validation failure
                                    </label>
                                    <p class="description">Automatically scroll to the first error field.</p>
                                    
                                    <label>
                                        <input type="checkbox" id="enable-honeypot" <?php checked($form && isset($form->settings) ? $form->settings['enable_honeypot'] ?? true : true); ?>>
                            ...
                            <!-- Legacy integration settings hidden - using new addon system only -->
                            <div class="integration-setting legacy-integration" style="display: none;">
                                <h4>Mailchimp Integration (Legacy - Disabled)</h4>
                                <div class="integration-option">
                                    <label>
                                        <input type="checkbox" id="enable-mailchimp" <?php checked($form && isset($form->settings) ? $form->settings['enable_mailchimp'] ?? false : false); ?>>
                                        Enable Mailchimp integration
                                    </label>
                                    <p class="description">Automatically add form submissions to your Mailchimp list.</p>
                                    
                                    <div id="mailchimp-settings" class="integration-settings-panel" style="display: none;">
                                        <div class="setting-row">
                                            <label for="mailchimp-api-key">API Key</label>
                                            <input type="text" id="mailchimp-api-key" class="widefat" value="<?php echo esc_attr($form && isset($form->settings) ? $form->settings['mailchimp_api_key'] ?? '' : ''); ?>" placeholder="Enter your Mailchimp API key">
                                            <p class="description">Get your API key from Mailchimp Account → Extras → API Keys</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="mailchimp-list-id">Audience/List ID</label>
                                            <input type="text" id="mailchimp-list-id" class="widefat" value="<?php echo esc_attr($form && isset($form->settings) ? $form->settings['mailchimp_list_id'] ?? '' : ''); ?>" placeholder="Enter your Mailchimp Audience ID">
                                            <p class="description">Find this in Mailchimp Audience → Settings → Audience name and defaults</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="mailchimp-email-field">Email Field</label>
                                            <select id="mailchimp-email-field" class="widefat">
                                                ...
                                                if ($form && isset($form->fields)) {
                                                    ...
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'email') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['mailchimp_email_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                            ...
                                            <p class="description">Select which field contains the email address</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="mailchimp-name-field">Name Field (Optional)</label>
                                            <select id="mailchimp-name-field" class="widefat">
                                                ...
                                                if ($form && isset($form->fields)) {
                                                    ...
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'text') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['mailchimp_name_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                            ...
                                            <p class="description">Select which field contains the subscriber's name</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label>
                                                <input type="checkbox" id="mailchimp-double-optin" <?php checked($form && isset($form->settings) ? $form->settings['mailchimp_double_optin'] ?? true : true); ?>>
                                                Enable double opt-in
                                            </label>
                                            <p class="description">Subscribers will receive a confirmation email before being added to the list</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="integration-setting legacy-integration" style="display: none;">
                                <h4>HubSpot Integration (Legacy - Disabled)</h4>
                                <div class="integration-option">
                                    <label>
                                        <input type="checkbox" id="enable-hubspot" <?php checked($form && isset($form->settings) ? $form->settings['enable_hubspot'] ?? false : false); ?>>
                                        Enable HubSpot integration
                                    </label>
                                    <p class="description">Automatically create contacts in HubSpot from form submissions.</p>
                                    
                                    <div id="hubspot-settings" class="integration-settings-panel" style="display: none;">
                                        <div class="setting-row">
                                            <label for="hubspot-api-key">API Key</label>
                                            <input type="text" id="hubspot-api-key" class="widefat" value="<?php echo esc_attr($form && isset($form->settings) ? $form->settings['hubspot_api_key'] ?? '' : ''); ?>" placeholder="Enter your HubSpot API key">
                                            <p class="description">Get your API key from HubSpot Settings → Integrations → API Keys</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="hubspot-portal-id">Portal ID</label>
                                            <input type="text" id="hubspot-portal-id" class="widefat" value="<?php echo esc_attr($form && isset($form->settings) ? $form->settings['hubspot_portal_id'] ?? '' : ''); ?>" placeholder="Enter your HubSpot Portal ID">
                                            <p class="description">Find this in HubSpot Settings → Account Setup → Account Information</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="hubspot-email-field">Email Field</label>
                                            <select id="hubspot-email-field" class="widefat">
                                                <option value="">Select email field</option>
                                                <?php
                                                if ($form && isset($form->fields)) {
                                                    $fields = json_decode($form->fields, true);
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'email') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['hubspot_email_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                        ...
                                        <div class="setting-row">
                                            <label for="hubspot-firstname-field">First Name Field (Optional)</label>
                                            <select id="hubspot-firstname-field" class="widefat">
                                                <option value="">Select first name field</option>
                                                <?php
                                                if ($form && isset($form->fields)) {
                                                    $fields = json_decode($form->fields, true);
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'text') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['hubspot_firstname_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                            ...
                                            <p class="description">Select which field contains the first name</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="hubspot-lastname-field">Last Name Field (Optional)</label>
                                            <select id="hubspot-lastname-field" class="widefat">
                                                <option value="">Select last name field</option>
                                                <?php
                                                if ($form && isset($form->fields)) {
                                                    $fields = json_decode($form->fields, true);
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'text') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['hubspot_lastname_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                            ...
                                            <p class="description">Select which field contains the last name</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="hubspot-phone-field">Phone Field (Optional)</label>
                                            <select id="hubspot-phone-field" class="widefat">
                                                    ...
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'text' || $field['type'] === 'number') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['hubspot_phone_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                            ...
                                            <p class="description">Select which field contains the phone number</p>
                                        </div>
                                        
                                        <div class="setting-row">
                                            <label for="hubspot-company-field">Company Field (Optional)</label>
                                            <select id="hubspot-company-field" class="widefat">
                                                ...
                                                if ($form && isset($form->fields)) {
                                                    ...
                                                    if ($fields) {
                                                        foreach ($fields as $field) {
                                                            if ($field['type'] === 'text') {
                                                                $selected = ($form && isset($form->settings) ? $form->settings['hubspot_company_field'] ?? '' : '') === $field['id'] ? 'selected' : '';
                                                                echo '<option value="' . esc_attr($field['id']) . '" ' . $selected . '>' . esc_html($field['label']) . '</option>';
                                                            }
                                                        }
                                                    }
                                            ...
                                            <p class="description">Select which field contains the company name</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    public function ajax_save_form() {
        try {
            ...
            // Debug: Log the received settings data
            error_log('🔧 DEBUG: Received settings JSON: ' . $settings);
            error_log('🔧 DEBUG: Decoded settings data: ' . print_r($settings_data, true));
            error_log('🔧 DEBUG: Mailchimp API key in settings: ' . ($settings_data['mailchimp_api_key'] ?? 'NOT SET'));
            ...
            // Debug: Log the final settings JSON being saved
            error_log('🔧 DEBUG: Final settings JSON to save: ' . $settings);
            ...
            if ($form_id) {
                ...
                // Debug: Confirm database update and check what was actually saved
                error_log('🔧 DEBUG: Database update result: ' . ($result !== false ? 'SUCCESS' : 'FAILED'));
                error_log('🔧 DEBUG: Rows affected: ' . $result);
                
                // Verify what was actually saved to database
                $saved_form = $wpdb->get_row($wpdb->prepare("SELECT settings FROM $table_name WHERE id = %d", $form_id));
                if ($saved_form) {
                    $saved_settings = json_decode($saved_form->settings, true);
                    error_log('🔧 DEBUG: Verified saved API key in database: ' . ($saved_settings['mailchimp_api_key'] ?? 'NOT FOUND'));
                }
            ...
            // Handle integration settings if present
            $integration_settings = isset($_POST['integration_settings']) ? stripslashes($_POST['integration_settings']) : '';
            if (!empty($integration_settings)) {
                $integration_data = json_decode($integration_settings, true);
                if (json_last_error() === JSON_ERROR_NONE && is_array($integration_data)) {
                    // Save integration settings in custom table
                    ...
                    // Delete existing integration settings
                    ...
                    $wpdb->insert(
                        ...
                        array(
                            ...
                            'meta_value' => json_encode($integration_data)
                        ),
                        array('%d', '%s', '%s')
                    );
                    
                    // Debug logging
                    error_log('🔧 DEBUG: Saved integration settings for form ' . $form_id . ': ' . print_r($integration_data, true));
                }
            }
    ...
    public function ajax_debug_form_settings() {
        check_ajax_referer('mavlers_cf_nonce', 'nonce');
        ...
        $debug_info = array(
            ...
            'raw_settings_json' => $form->settings,
            'decoded_settings' => $settings,
            'mailchimp_api_key' => $settings['mailchimp_api_key'] ?? 'NOT SET',
            'mailchimp_enabled' => $settings['enable_mailchimp'] ?? false,
            'all_mailchimp_settings' => array(
                'enable_mailchimp' => $settings['enable_mailchimp'] ?? false,
                'mailchimp_api_key' => $settings['mailchimp_api_key'] ?? '',
                'mailchimp_list_id' => $settings['mailchimp_list_id'] ?? '',
                'mailchimp_email_field' => $settings['mailchimp_email_field'] ?? '',
                'mailchimp_name_field' => $settings['mailchimp_name_field'] ?? '',
                'mailchimp_double_optin' => $settings['mailchimp_double_optin'] ?? true
            )
        );
        
        error_log('🔍 DEBUG: Form settings for ID ' . $form_id . ': ' . print_r($debug_info, true));
